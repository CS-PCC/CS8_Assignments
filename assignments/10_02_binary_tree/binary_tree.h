...
//
//   int balance_factor()
//     Postcondition: The return value is balance factor of node.
//     balance factor = height of the left subtree - the height of the right subtree
//     a NULL child has a height of -1
//     a leaf has a height of 0
//
//   const int height()
//     Postcondition: The return value is the height of node.
//     Height of a node is 1 + height of the "taller" child
//     A leaf node has a height of zero: 1 + max(-1, -1)
//
//   int update_height()
//     Postcondition: The return value is the updated height.
//     update the height of node (call height();)
//
...
//
//   template <class Item>
//   void print(const binary_tree_node<Item>* node_ptr, int depth=0)
//     Precondition: node_ptr is a pointer to a node in a binary tree (or
...
//     its depth.
//
//   void print_debug(const binary_tree_node<Item>* node_ptr, int depth=0)
//     Precondition: node_ptr is a pointer to a node in a binary tree (or
//     node_ptr may be NULL to indicate the empty tree). If the pointer is
//     not NULL, then depth is the depth of the node pointed to by node_ptr.
//     Postcondition: If node_ptr is non-NULL, then the contents of *node_ptr
...
//     using a backward in-order traversal. Each node is indented four times
//     its depth.
//     Print format: [data_field:tree_height (balance_factor)]
//
//   template <class Item>
